...
local TRANSLATE_TO_PREFABS=ForestMap.TRANSLATE_TO_PREFABS
local MULTIPLY=ForestMap.MULTIPLY
...
-- moving lava code into post populate was not enough
-- It still detects 'disconnects' where it shouldn't be able to detect them
-- Walls? Tiled? Does Engine know about walls at that point, and if not (which I suspect it shouldn't ) why do my maps fail?
-- this shouldn't have been made necesary...
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
--------------DF FOREST GENERATOR BRUTE FORCE OVERRIDE-------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
...
local DFLevelGenerate=function(prefab, map_width, map_height, tasks, world_gen_choices, level_type, level)
	...
	-- NO removal of items on lava, for the sake of special fx or other mischief
--[[
