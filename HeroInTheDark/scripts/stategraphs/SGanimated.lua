		...
		if not inst.components.health:IsDead() then
			if data.attacker and data.attacker:HasTag("insect") then
                ...
                if not is_idle then
                    ...
                    inst.SoundEmitter:PlaySound("fa/mobs/thulearmor/armor_hit")        
...
--            inst.components.hunger:Resume()
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("fa/mobs/thulearmor/armor_die")
        ...
        onenter = function(inst)
            ...
            if weapon then
                ...
                elseif weapon:HasTag("firestaff") then
                    ...
                    inst.SoundEmitter:PlaySound("fa/mobs/thulearmor/armor_atk")
                end
...
return StateGraph("animated", states, events, "idle", actionhandlers)
