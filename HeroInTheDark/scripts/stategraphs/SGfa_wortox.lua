		...
		if not inst.components.health:IsDead() then
			if data.attacker and data.attacker:HasTag("insect") then
                ...
                if not is_idle then
                    ...
                    inst.SoundEmitter:PlaySound("fa/mobs/demon/skel_hit")        
...
--            inst.components.hunger:Resume()
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("fa/mobs/demon/die")
...
--            inst.components.hunger:Resume()
   ...
   State{
        ...
        onenter = function(inst)
            ...
            if weapon then
                ...
                elseif weapon:HasTag("firestaff") then
                    ...
                    inst.SoundEmitter:PlaySound("fa/mobs/demon/atk")
                end
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("fa/mobs/demon/hit")        
...
return StateGraph("fa_wortox", states, events, "idle", actionhandlers)
