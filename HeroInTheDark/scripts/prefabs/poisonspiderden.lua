...
local assets =
{
    Asset("ANIM", "anim/poisonspider_cocoon.zip"),
        ...
        if inst.components.childspawner then
            ...
            for k = 1,num_to_release do
                if k <= num_warriors then
                    ...
                    inst.components.childspawner.childname = "poisonspider"--"spider"
                end
...
return Prefab( "forest/monsters/poisonspiderden", MakeSpiderDenFn(1), assets, prefabs ),
       Prefab( "forest/monsters/poisonspiderden_2", MakeSpiderDenFn(2), assets, prefabs ),
       Prefab( "forest/monsters/poisonspiderden_3", MakeSpiderDenFn(3), assets, prefabs ) 