...
local r=Recipe("fa_coppersword_recipe", {Ingredient("gold", 20)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFWEAPONRECIPES, nil, nil, true)
r.image="blueprint.png"
local r=Recipe("fa_copperaxe_recipe", {Ingredient("gold", 20)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFWEAPONRECIPES, nil, nil, true)
r.image="blueprint.png"
local r=Recipe("fa_copperdagger_recipe", {Ingredient("gold", 20)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFWEAPONRECIPES, nil, nil, true)
r.image="blueprint.png"
...
local r=Recipe("fa_copperarmor_recipe", {Ingredient("gold", 20)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFARMORRECIPES, nil, nil, true)
r.image="blueprint.png"
...
r.image="blueprint.png"
local r=Recipe("fa_hat_copper_recipe", {Ingredient("gold", 20)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFARMORRECIPES, nil, nil, true)
r.image="blueprint.png"
...
local r=Recipe("fa_copperbar_recipe", {Ingredient("gold", 5)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFSMELTRECIPESTAND, nil, nil, true)
r.image="blueprint.png"
local r=Recipe("fa_ironbar_recipe", {Ingredient("gold", 10)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFSMELTRECIPESTAND, nil, nil, true)
r.image="blueprint.png"
...
r.image="blueprint.png"
local r=Recipe("fa_lavabar_recipe", {Ingredient("gold", 10)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFSMELTRECIPESTAND, nil, nil, true)
r.image="blueprint.png"
local r=Recipe("fa_coalbar_recipe", {Ingredient("gold", 2)}, RECIPETABS.FA_DWARFTRADER, TECH.FA_DORFSMELTRECIPESTAND, nil, nil, true)
r.image="blueprint.png"
