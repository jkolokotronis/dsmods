...
FA_ModUtil.AddPrefabPostInit("gnatmound", function(inst) FA_ModUtil.addT1LootPrefabPostInit(inst,0.01) end)
FA_ModUtil.AddPrefabPostInit("molehill", function(inst) FA_ModUtil.addT1LootPrefabPostInit(inst,0.02) end)
